...
//상품 수정페이지
router.route('/process/product/modify/:_id').get(function(req, res) {
    console.log('GET : /process/product/modify');
...
//상품 수정
router.route('/process/product/modify/:_id').post(function(req, res) {
    console.log('POST : /process/product/modify');
    console.log(req.params._id);
    var _id = req.params._id;
    res.end(_id);
});
...
//상품 삭제
router.route('/process/product/delete/:_id').get(function(req, res) {
    console.log('GET : /process/product/delete');
    console.log(req.params._id);
    var _id = req.params._id;
    res.end(_id);
});
